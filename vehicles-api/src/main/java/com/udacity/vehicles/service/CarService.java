...
//        Car car = new Car();
         ...
         */
        Location loc = car.get().getLocation();
        Double lat = loc.getLat();
        Double lon = loc.getLon();
        Address addr = maps.get().uri("maps?lat="+lat+"&lon="+lon)
                .retrieve()
                .bodyToMono(Address.class)
                .block();
        loc.setAddress(addr.getAddress());
        loc.setCity(addr.getCity());
        loc.setState(addr.getState());
        loc.setZip(addr.getZip());
    ...
    public void delete(Long id) {
         ...
         */
//        repository.findById(id).ifPresentOrElse(repository::delete, CarNotFoundException::new);
